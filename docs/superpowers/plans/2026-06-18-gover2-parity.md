...
- [x] **Step 1: Regenerate bindings via wails build**
...
- [x] **Step 2: Go build + full Go test with coverage**

Run: `cd /home/mg/inventory/gover2 && go build ./... && go test ./... -cover`
Expected: PASS; services ≥ 70%, bridge ≥ 50%.

- [x] **Step 3: Frontend typecheck + full test run**

Run: `cd /home/mg/inventory/gover2/frontend && pnpm run typecheck && pnpm test`
Expected: both PASS.

- [x] **Step 4: Manual smoke test (record results)**
...
- [x] **Step 5: Commit generated bindings**
